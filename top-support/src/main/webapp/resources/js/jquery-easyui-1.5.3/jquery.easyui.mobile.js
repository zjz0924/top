...
(function($) {
			...
			return this.each(function() {
				...
				if (_4) {
					...
					_4 = $.data(this, "navpanel", {
						options : $.extend({}, $.fn.navpanel.defaults,
								$.fn.navpanel.parseOptions(this), _1)
					});
				}
	...
	$.fn.navpanel.parseOptions = function(_5) {
		return $.extend({}, $.fn.panel.parseOptions(_5), $.parser.parseOptions(
				_5, []));
	};
...
(function($) {
			...
			$(document)
					...
					.bind(
							...
							function(e) {
								...
								if (a.length) {
									var _8 = $.parser.parseOptions(a[0], [
											"animation", "direction", {
												back : "boolean"
											} ]);
									if (_8.back) {
	...
	$.map([ "validatebox", "textbox", "passwordbox", "filebox", "searchbox",
			...
			"datebox", "datetimebox", "numberbox", "spinner", "numberspinner",
			"timespinner", "datetimespinner" ], function(_19) {
		if ($.fn[_19]) {
