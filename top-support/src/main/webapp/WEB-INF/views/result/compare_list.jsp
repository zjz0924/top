...
<html>
	<head>
		...
		<script type="text/javascript">
			var getDataUrl = "${ctx}/result/compareListData?type=${type}";
			var getRecordUrl = "${ctx}/ots/taskRecordListData";
			var datagrid = "compareTable";
			...
			function closeDialog(msg) {
				$('#compareDetailDialog').dialog('close');
				tipMsg(msg, function(){
	...
	<body>
		...
		<div style="margin-top: 25px; padding-left: 20px; margin-bottom: 10px;font-size:12px;margin-left: 5%;margin-right: 5%;">
			...
			<div style="margin-top:10px;">
				<table id="compareTable" style="height:auto;width:auto"></table>
			</div>
			...
			<div id="compareDetailDialog"></div>
